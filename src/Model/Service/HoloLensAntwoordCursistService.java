...
public class HoloLensAntwoordCursistService {
	...
	public Boolean maakAntwoordCursistAan(@PathParam("ant")String antwoord, @PathParam("u")String username, @PathParam("pw")String pw) throws NoSuchAlgorithmException, InvalidKeySpecException {
